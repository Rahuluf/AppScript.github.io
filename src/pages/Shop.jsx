  ...
  const handleFilter = (filterType) => {
    ...
    switch (filterType) {
      ...
      case "low-to-high":
        ...
        break;
      case "recommended":
        sortedProducts = [...products].filter(product => product.rating.rate >= 4);
        break;
      default:
  ...
  return (
    <>
      ...
      <Container mt={4} maxW="container.lg">
        ...
        >
          {filteredProducts.map((product) => (
            <Card key={product.id} maxW="sm" borderRadius="md" boxShadow="md">
              <Image src={product.image} alt={product.title} borderTopRadius="md" />
              <CardBody>
                <Stack spacing={3}>
                  <Text fontWeight="bold" fontSize="lg">{product.title}</Text>
                  <Text fontSize="md" color="gray.600">Price: ${product.price}</Text>
                  <Text fontSize="sm" color="gray.500">Rating: {product.rating.rate} ({product.rating.count} reviews)</Text>
      ...
      <Box mt={8} p={4} bg="gray.100" textAlign="center">
        ...
        <Box mt={2}>
          <Button variant="ghost" as="a" href="" leftIcon={<FaFacebook />} />
          <Button variant="ghost" as="a" href="" leftIcon={<FaTwitter />} />
          <Button variant="ghost" as="a" href="" leftIcon={<FaInstagram />} />
